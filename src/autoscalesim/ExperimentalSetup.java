    ...
    /* Auto-Scaling setup */
        ...
        /* Analyzer */
            ...
            String[] analysisMethod = new String[]{
                Method.COMPLEX_SES.name(),//[0] method for analyzing 'CPU utilization' parameter
                Method.COMPLEX_SES.name(),//[1] method for analyzing 'Vm count' parameter
                Method.COMPLEX_SES.name(),//[2] method for analyzing 'Throughput' parameter
                Method.COMPLEX_SES.name(),//[3] method for analyzing 'Response Time' parameter
                Method.COMPLEX_SES.name(),//[4] method for analyzing 'Delay time' parameter
                Method.COMPLEX_SES.name(),//[5] method for analyzing 'SLA violation Count' parameter
                Method.COMPLEX_SES.name(),//[6] method for analyzing 'SLA violation percent parameter'
                Method.COMPLEX_SES.name(),//[7] method for analyzing 'SLA violation time' parameter
                Method.COMPLEX_SES.name(),//[8] method for analyzing 'Failed Cloudlets' parameter
                Method.COMPLEX_SES.name()};//[9] method for analyzing 'Future Workload' parameter
        ...
        /* Planner (resource estimation, capacity planning, or decision making) */
            ...
            double delayTimeScaleUpThreshold = 1.40; // second //NASA=1, Wikipedia=0.140
...
/* (C) Cloud Provider */
        ...
        // "Dynamic" which is related to OS, Time of the day, Server Location, the number of requested instances, etc.
            ...
            final double BASE_DELAY_IN_VM_START_UP =  AutoScaleSimTags.aMinute; //NASA=5, Wikipedia=1
